...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: HorizontalDevelop
--- !u!114 &8
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-112.0,"y":-169.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -112, y: -169}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
  ...
  m_Position:
    ...
    speed: 2
    m_Value: {x: -24.161718, y: 3.5924869, z: 90}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_DrawArea:
      ...
      width: 925
      height: 472
    m_Scale: {x: 0.45014814, y: 0.45014814}
    m_Translation: {x: 462.5, y: 234.29001}
    m_MarginLeft: 0
    m_MarginRight: 0
    m_MarginTop: 0
    m_MarginBottom: 0
    m_LastShownAreaInsideMargins:
      ...
      height: 1048.5437
    m_MinimalGUI: 1
  m_defaultScale: 0.43703705
  m_LastWindowPixelSize: {x: 925, y: 493}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      ...
      m_SelectedIDs: 
      m_LastClickedID: 0
      m_ExpandedIDs: 329efeff3a9efeff289ffeff
      m_RenameOverlay:
