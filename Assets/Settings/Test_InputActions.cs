...
//     version 1.14.2
//     from Assets/Settings/Test_InputActions.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Settings/Test_InputActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Test_InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@Test_InputActions()
    {
        UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, Test_InputActions.Player.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, Test_InputActions.UI.Disable() has not been called.");
    }
    ...
    public struct UIActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public UIActions(@Test_InputActions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
